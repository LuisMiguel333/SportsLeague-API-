...
public static class DataSeeder
{
    public static async Task SeedAsync(LeagueDbContext context)
    {
        ...
        var teams = new List<Team>
        {
            ...
            new() { Name="Independiente Medellín", City="Medellín", Stadium="Atanasio Girardot", FoundedDate=new DateTime(1913,5,16) },
            new() { Name="América de Cali", City="Cali", Stadium="Pascual Guerrero", FoundedDate=new DateTime(1927,2,13) },
            new() { Name="Deportivo Cali", City="Cali", Stadium="Deportivo Cali", FoundedDate=new DateTime(1912,6,12) },
            new() { Name="Junior FC", City="Barranquilla", Stadium="Metropolitano", FoundedDate=new DateTime(1924,8,18) },
            new() { Name="Millonarios FC", City="Bogotá", Stadium="El Campín", FoundedDate=new DateTime(1946,6,18) },
            new() { Name="Independiente Santa Fe", City="Bogotá", Stadium="El Campín", FoundedDate=new DateTime(1941,8,26) },
            new() { Name="Deportes Tolima", City="Ibagué", Stadium="Manuel Murillo Toro", FoundedDate=new DateTime(1954,2,28) },
            new() { Name="Atlético Bucaramanga", City="Bucaramanga", Stadium="Alfonso López", FoundedDate=new DateTime(1949,8,8) },
            new() { Name="Once Caldas", City="Manizales", Stadium="Palogrande", FoundedDate=new DateTime(1961,9,8) },
            new() { Name="Deportivo Pasto", City="Pasto", Stadium="Departamental Libertad", FoundedDate=new DateTime(1949,5,8) },
            new() { Name="Deportivo Pereira", City="Pereira", Stadium="Hernán Ramírez Villegas", FoundedDate=new DateTime(1944,6,26) },
            new() { Name="Águilas Doradas", City="Rionegro", Stadium="Alberto Grisales", FoundedDate=new DateTime(2010,1,1) },
            new() { Name="Boyacá Chicó FC", City="Tunja", Stadium="La Independencia", FoundedDate=new DateTime(2000,1,1) },
            new() { Name="Jaguares de Córdoba", City="Montería", Stadium="Jaraguay", FoundedDate=new DateTime(2008,1,1) },
            new() { Name="Alianza Valledupar FC", City="Valledupar", Stadium="Armando Maestre", FoundedDate=new DateTime(2015,1,1) },
            new() { Name="Fortaleza FC", City="Bogotá", Stadium="Metropolitano de Techo", FoundedDate=new DateTime(2014,1,1) },
            new() { Name="Llaneros FC", City="Villavicencio", Stadium="Bello Horizonte", FoundedDate=new DateTime(2011,1,1) },
            new() { Name="Cúcuta Deportivo", City="Cúcuta", Stadium="General Santander", FoundedDate=new DateTime(1924,7,1) },
            new() { Name="Internacional de Bogotá", City="Bogotá", Stadium="Metropolitano de Techo", FoundedDate=new DateTime(2018,1,1) },
        };
        context.Teams.AddRange(teams);
        await context.SaveChangesAsync();

        // ═══ 2. JUGADORES (4 por equipo) ═══
